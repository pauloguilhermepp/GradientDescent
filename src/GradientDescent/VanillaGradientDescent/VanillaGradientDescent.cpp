...
void VanillaGradientDescent::showSolution() {
  ...
  std::cout << std::endl;
  std::cout << "EvaluationFunctionValue: " << evaluationFunc(solution)
            << std::endl;
}
...
long double VanillaGradientDescent::uniformRandomNum(long double MinValue,
...
VanillaGradientDescent::uniformVectorRandomNum(int size) {
