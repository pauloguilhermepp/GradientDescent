...
MomentumGradientDescent::MomentumGradientDescent(int NumVar, int NumIt,
                        long double Alpha, long double Beta, long double Dx,
                        long double MinValue, long double MaxValue,
                        long double (*EvaluationFunc)(std::vector<long double>)):
                        VanillaGradientDescent(NumVar, NumIt, Alpha, Dx, MinValue,
                        MaxValue, *EvaluationFunc){
                            beta = Beta;
}
